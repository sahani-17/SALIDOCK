...
const Documentation = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section id="docs-hero" className="relative pt-32 pb-16 overflow-hidden flex items-center">
        <div className="max-w-5xl mx-auto px-8 md:px-12 relative z-10 w-full">
          <AnimatedSection>
            ...
            <p className="text-muted-foreground font-medium leading-[1.8] text-[15px] max-w-3xl">
        ...
        <div className="max-w-5xl mx-auto px-8 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <AnimatedSection className="order-2 md:order-1 flex flex-col gap-10">
              <div className="text-muted-foreground font-medium leading-[1.8] text-[15px]">
              ...
              <div className="flex flex-col gap-6">
                {/* Card 1 */}
                <div className="relative p-8 border border-border rounded-sm bg-muted/20">
      ...
      <section id="active-site" className="pb-24 relative pt-12 border-y border-border">
        <div className="max-w-5xl mx-auto px-8 md:px-12">
          ...
          <AnimatedSection className="mb-12">
             <div className="flex items-center gap-6">
                ...
                <div>
                   <h2 className="text-[16px] font-bold text-foreground tracking-wider mb-1 uppercase">Active-Site Precision</h2>
                   <div className="text-[11px] font-bold tracking-widest text-muted-foreground uppercase">
        ...
        <div className="max-w-5xl mx-auto px-8 md:px-12">
          ...
          <AnimatedSection className="mb-12">
             <div className="flex items-center gap-6">
                ...
                <div>
                   <h2 className="text-[16px] font-bold text-foreground tracking-wider mb-1 uppercase">Unprecedented Insight</h2>
                   <div className="text-[11px] font-bold tracking-widest text-muted-foreground uppercase">
          ...
          <AnimatedSection delay={100} className="mb-10">
              <div className="text-muted-foreground font-medium leading-[1.8] text-[15px] max-w-3xl">
            ...
            <AnimatedSection delay={100} className="h-full">
              <div className="relative p-1 border border-border rounded-sm bg-muted/20 h-full flex flex-col">
                ...
                <div className="p-6 flex flex-col h-full">
                  ...
                  <img src="/mol.png" alt="Compare Poses" className="rounded-lg shadow-sm border border-border mb-4 w-full" />
                  <p className="text-[14px] text-muted-foreground font-medium leading-[1.7] mt-auto">Browse generated spatial conformations systematically and check the overall docking trajectory.</p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={200} className="h-full">
              <div className="relative p-1 border border-border rounded-sm bg-muted/20 h-full flex flex-col">
                ...
                <div className="p-6 flex flex-col h-full">
                  ...
                  <img src="/2d_interaction.png" alt="2D Interaction Diagrams" className="rounded-lg shadow-sm border border-border mb-4 w-full" />
                  <p className="text-[14px] text-muted-foreground font-medium leading-[1.7] mt-auto">Automatically-generated 2D interaction maps pinpointing hydrogen bonds and hydrophobic pockets.</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection delay={250}>
            <div className="relative p-8 md:p-10 border border-border rounded-sm bg-muted/20 mb-8 overflow-hidden">
              <div className="absolute top-0 left-0 w-2.5 h-2.5 border-t-[2.5px] border-l-[2.5px] border-primary" />
              <div className="absolute bottom-0 right-0 w-2.5 h-2.5 border-b-[2.5px] border-r-[2.5px] border-primary" />
              ...
              <p className="text-[15px] text-muted-foreground font-medium leading-[1.8] mb-8 max-w-3xl">
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="text-[13px] text-muted-foreground font-medium space-y-3">
                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary shrink-0 mt-1.5" />Navigate to any generated pose in the 3D Viewer.</li>
                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary shrink-0 mt-1.5" />Adjust your camera angle, zoom, and clipping planes.</li>
                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary shrink-0 mt-1.5" />Click the Download Icon in the viewer toolbar.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-[13px] text-muted-foreground font-medium space-y-3">
                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary shrink-0 mt-1.5" />Open the 2D Interactions tab in the Results Panel.</li>
                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary shrink-0 mt-1.5" />Pan and zoom the SVG layout to your focus area.</li>
                    <li className="flex gap-2"><div className="w-1.5 h-1.5 rounded-full bg-primary shrink-0 mt-1.5" />Click the Download Icon to save a lossless SVG.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-border">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="relative pl-4 border-l-2 border-primary/20">
                    <h5 className="text-[12px] font-bold text-primary uppercase tracking-wide mb-2">
          ...
          <AnimatedSection delay={300}>
            <div className="relative p-1 border border-border rounded-sm bg-muted/20 overflow-hidden">
               ...
               <div className="bg-card p-2">
                 <img src="/table.png" alt="Affinity Tables" className="rounded border border-border shadow-sm w-full mx-auto" />
               </div>
            </div>
          </AnimatedSection>
