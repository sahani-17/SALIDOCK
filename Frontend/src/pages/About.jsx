        ...
        <div className="max-w-5xl mx-auto px-8 md:px-12 relative z-10">
          <AnimatedSection>
            ...
            <div className="flex flex-col gap-6 w-full max-w-4xl">
              {/* Card 1 */}
              <div className="flex flex-col md:flex-row items-center md:items-center gap-8 p-8 md:px-10 md:py-8 border border-border bg-card overflow-hidden relative">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-muted to-transparent pointer-events-none -mr-16 -mt-16 transform rotate-12" />
                <div className="w-[72px] h-[72px] shrink-0 bg-muted flex items-center justify-center relative z-10">
                ...
                <div className="flex flex-col gap-2 relative z-10 text-center md:text-left">
                  <h3 className="text-[20px] md:text-[22px] font-bold text-foreground tracking-tight">Academic Researchers</h3>
                  <p className="text-muted-foreground font-medium text-[14px] md:text-[15px] leading-[1.8]">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-center gap-8 p-8 md:px-10 md:py-8 border border-border bg-card overflow-hidden relative">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-muted to-transparent pointer-events-none -mr-16 -mt-16 transform rotate-12" />
                <div className="w-[72px] h-[72px] shrink-0 bg-muted flex items-center justify-center relative z-10">
                  <Factory className="w-8 h-8 text-primary" strokeWidth={2} />
                </div>
                <div className="flex flex-col gap-2 relative z-10 text-center md:text-left">
                  <h3 className="text-[20px] md:text-[22px] font-bold text-foreground tracking-tight">Industry Professionals</h3>
                  <p className="text-muted-foreground font-medium text-[14px] md:text-[15px] leading-[1.8]">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-center gap-8 p-8 md:px-10 md:py-8 border border-border bg-card overflow-hidden relative">
                ...
                <div className="flex flex-col gap-2 relative z-10 text-center md:text-left">
                  <h3 className="text-[20px] md:text-[22px] font-bold text-foreground tracking-tight">Bioinformatics Students</h3>
                  <p className="text-muted-foreground font-medium text-[14px] md:text-[15px] leading-[1.8]">
